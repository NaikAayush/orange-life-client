...
* @returns {any[]}
*/
export function generateKFrags(delegating_sk: SecretKey, receiving_pk: PublicKey, signer: Signer, threshold: number, num_kfrags: number, sign_delegating_key: boolean, sign_receiving_key: boolean): any[];
/**
* @param {Capsule} capsule
...
* @returns {SecretKey}
*/
  secretKeyByLabel(label: Uint8Array): SecretKey;
/**
* @returns {Uint8Array}
*/
  toSecretBytes(): Uint8Array;
...
* @returns {boolean}
*/
  verify(verifying_key: PublicKey, message: Uint8Array): boolean;
/**
* @returns {Uint8Array}
*/
  toBytes(): Uint8Array;
