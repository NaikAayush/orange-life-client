...
* @returns {any[]}
*/
export function generateKFrags(delegating_sk, receiving_pk, signer, threshold, num_kfrags, sign_delegating_key, sign_receiving_key) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(delegating_sk, SecretKey);
...
export function __wbg_new_3e1ee746fe308c9f(arg0, arg1) {
